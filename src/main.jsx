...
import ExploreDetailDestinationPage from './pages/explore/destination/[province]/[name]/index.jsx';
...
const routes = createBrowserRouter([
  ...
  {
    path: "/explore-destination/:province/:name",
    element: (
      <TitleLayout>
        <ExploreDetailDestinationPage />
      </TitleLayout>
    ),
  },
  {
