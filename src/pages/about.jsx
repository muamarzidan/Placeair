    ...
    return (
        <>
            ...
            <main className="w-full h-auto bg-white">
                ...
                <section id="about-us" className="w-full h-auto py-10">
                    <div className="container w-full h-auto">
                        <div className="flex flex-col justify-between w-full h-auto gap-2 text-center">
                            <span className="text-secondary text-sm sm:text-lg md:text-2xl xl:text-[24px]">ABOUT US</span>
                ...
                <section id="team" className="w-full h-auto py-1 sm:py-10 md:py-20">
                    <div className="container w-full h-auto">
                        <div className="flex flex-col justify-between w-full h-auto gap-2 text-center">
                            ...
                            <div className="flex items-center justify-center w-full h-auto gap-0 sm:gap-7 lg:gap-14 !mt-8">
                ...
                <section id="choose" className="w-full h-auto my-10 md:my-20">
                    <div className="container flex flex-wrap-reverse items-center w-full h-auto gap-0 sm:gap-10 md:gap-0 md:h-auto">
                        ...
                        <div className="flex items-center justify-between w-full h-full gap-2 pr-0 lg:pr-14 basis-full md:basis-1/2">
                            <img src={imageChoosePlaceir} alt="about banner placeir" className="w-full h-full max-h-[300px] md:max-h-[400px] lg:max-h-[454px] xl:max-h-[524px] object-cover object-center rounded-2xl brightness-[75%] md:brightness-100" />
                        </div>
                        {/* Right/top side about area */}
                        <div className="flex flex-col justify-between w-full h-full gap-1 my-7 xl:gap-2 md:pl-8 xl:pl-5 basis-full md:basis-1/2">
                            <h4 className="text-sm font-semibold sm:text-lg md:text-xl xl:text-2xl text-secondary">ABOUT PLACEIR</h4>
                            <h3 className="text-2xl font-semibold sm:text-5xl xl:text-6xl">Fitur Unik Placeir</h3>
