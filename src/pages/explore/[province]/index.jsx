...
export default function ExploreProvincePage() {
    ...
    // handler thumbnail and bg music
    useEffect(() => {
        const fetchProvinceData = async () => {
            ...
            if (filteredByProvince.length > 0) {
                ...
                setBgMusic(filteredByProvince[0].bgMusic);
            }
        };
        fetchProvinceData();
        return () => {
    ...
    const filterDestinationByProvince = dataDestination.filter(destination => destination.province.toLowerCase() === province.toLowerCase())
